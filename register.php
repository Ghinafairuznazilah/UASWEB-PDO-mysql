...
body {
    background-image: url(image/new9.png);
...
<!--card-->
  <div id="card">
    <div id="card-content">
      ...
      <label for="namadepan" style="padding-top:13px">
            &nbsp;
          </label>Nama depan
          <div class="form-group">
        <input id="namadepan" class="form-control" type="text" name="namadepan" required/>
        </div>
        <div class="form-border"></div>
        <label for="namabelakang" style="padding-top:13px">
            &nbsp;
          </label>Nama Belakang
          <div class="form-group">
        <input id="namabelakang" class="form-control" type="text" name="namabelakang" required />
        </div>
        <div class="form-border"></div>
        ...
        <button name="Register" type="submit" input id="submit-btn" >Register</button>
        <a href="login.php" id="signup">Already Registered?</a>
